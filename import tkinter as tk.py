...
dialogue = (
    ...
    "領主Ａ：請跟隨我們的手下，在這平行時空中幫助可憐的菲利爾解決問題扭轉人生。由於分散後的靈魂極不穩定，每個時空的入口處最多只能有四個分靈同時存在。\n\n"
    "領主Ｂ：要解決的問題都寫在信封上了，現在請我們的手下上來領取你們的信封吧。偷偷告訴你們吧，信封上寫著你們要解決的問題以及能夠幫上忙的人，至於信封上的提示則代表你們要先前往的平行時空喔。\n\n"
    "領主Ｃ：此外，菲利爾一但被困在平行時空發太久，靈魂就會散去，導致他在現實世界消失。因此，你們需要蒐集有關菲利爾的線索，才能讓菲利爾的靈魂重新拼湊起來，回到現實世界喔！\n\n"
