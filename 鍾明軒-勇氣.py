...
class NPC:
    def __init__(self, name, image_path, x, y, dialog):
        ...
        self.image = pygame.transform.scale(self.image, (600, 375))
        self.x = x
        self.y = y
...
# 创建多个NPC
npcs = [
    NPC("鍾明軒", "鍾明軒.png", 100, 100, "哎呀～沒想到那熊貓把你們引薦給我\n看來是有點資質呢\n我就來教你們基本功吧！\
        \n這招叫「氣」！\n顧名思義就是要學著控制你們的氣息\n才能好好集氣\n我們開始練功吧！"),
]
...
options = ["可以唱煎熬給我聽嗎?", "被種族歧視怎麼辦", "我想學會基本功！"]
selected_index = 0
show_options = False
current_npc = None
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if dialog:
                    ...
                    if options[selected_index] == "我想學會基本功！":
